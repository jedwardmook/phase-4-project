...
puts "seeding"
    ...
    Host.create(name: "Kevan Lannister", listing_id: 2, image: "https://awoiaf.westeros.org/images/e/e3/Ser_Kevan_Lannister_unknown.jpg")
    ...
    Listing.create(name: "The Red Keep", location: "Crownlands", host_id: 2, photos: ["https://awoiaf.westeros.org/images/thumb/a/a1/Red_Keep_at_Kings_Landing%2C_Ted_Nasmith.jpg/900px-Red_Keep_at_Kings_Landing%2C_Ted_Nasmith.jpg"], price: 600,
        amenities: [])
